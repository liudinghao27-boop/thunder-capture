...
ADDITIVE_MIGRATIONS: dict[str, tuple[ColumnSpec, ...]] = {
    ...
    "sa_devices": (
        ...
        ColumnSpec("last_started_at", "DATETIME"),
        ColumnSpec("last_finished_at", "DATETIME"),
        ColumnSpec("last_checked_at", "DATETIME"),
        ...
        ColumnSpec("cooldown_until", "DATETIME"),
    ...
    "sa_jobs": (
        ...
        ColumnSpec("completed_at", "DATETIME"),
    ),
    "sa_screen_snapshots": (
        ...
        ColumnSpec("captured_at", "DATETIME"),
